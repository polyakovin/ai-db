...
- 90% скидка на prompt caching (выше, чем у OpenAI)
...
- Конкуренция со стороны open-weight моделей (GLM-5.2, DeepSeek V4) растёт

## Связи

- [[../../tools/gemini.md|Google Gemini]] — прямой конкурент по моделям и агентным возможностям
- [[../../tools/perplexity.md|Perplexity AI]] — альтернативная AI-платформа
