...
- **Claude Science** — beta-приложение для научных команд: scientific artifacts с provenance, встроенные scientific renderers, specialist/reviewer agents, reusable skills/connectors и orchestration вычислений на laptop, Linux box, HPC или Modal.
...
| **Claude Science** | Domain-specific research harness: coordinating agent + specialist agents, reviewer agent для citations/calculations/figures, 60+ scientific skills/connectors, reproducible artifacts |
...
- **Claude Science beta:** доступно на macOS и Linux для Pro, Max, Team и Enterprise; Team/Enterprise требуют включения администратором.
...
- **Scientific Research Workbench**: Claude Science для literature analysis, single-cell/genomics/proteomics/structural biology/cheminformatics workflows, reproducible figures и HPC jobs
...
- [Google Gemini](gemini.md) — прямой конкурент по моделям и агентным возможностям
- [Perplexity AI](perplexity.md) — альтернативная AI-платформа
- [OpenAI](../platforms/openai.md) — главный конкурент
- [Agent Harness](../../patterns/architecture-design/agent-harness.md) — Claude Code как реализация coding harness
- [Работа с код-агентами](../../patterns/implementation/working-with-coding-agents.md) — практический workflow с Claude Code
- [Исследование фреймворков](../agent-frameworks-research.md) — Claude Code в карте выбора
- [Модельная карта](../agent-model-map.md) — Claude модели в карте
- [Claude Science](../../sources/libraries-tools/claude-science.md) — источник по scientific workbench, provenance и reviewer loop
