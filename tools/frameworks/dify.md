...
- **Multi-model** — поддержка OpenAI, Anthropic, Gemini, Mistral, open-source моделей.
...
- Тонкий контроль над состоянием — LangGraph
- Coding-first workflow — Claude Code/Codex CLI
