...
- Мульти-агентные workflow (через [LangGraph](langgraph.md))
...
- Плюсы: порог входа нулевой, визуальное построение, интеграция с [LangChain](langchain.md)
- Минусы: не для сложной кастомной логики, vendor lock-in на [LangChain](langchain.md)-экосистему
