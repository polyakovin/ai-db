...
OpenTelemetry задаёт общий язык traces/spans/logs/metrics, а агентные платформы вроде LangSmith и Phoenix добавляют LLM-specific представления run, prompt, retrieval и tool calls.
...
- [Execution loop агента](../concepts/agent-execution-loop.md)
