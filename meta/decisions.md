...
| 2026-07-02 | LightRAG и его альтернативы вынесены в отдельные canonical-страницы в `tools/retrieval/`; `lightrag-alternatives.md` оставлен как карта выбора | Факты об инструментах должны жить на отдельных страницах; сравнительная заметка нужна только для маршрутизации между классами GraphRAG/RAG решений | Оставить все аналоги одной таблицей; разнести только LightRAG |
