...
- **Платформа:** BitGN (bitgn.com) — платформа для публичных бенчмарков AI-агентов
- **Миссия:** Превращать реальные workflow в воспроизводимые бенчмарки, где инженеры сравнивают архитектуры агентов в одинаковых условиях
- **Челленджи:** PAC1 (Personal Agent Challenge) — детерминированный бенчмарк для персональных агентов; ECOM1 — агентная электронная коммерция
- **Формат:** Сотни агентов, слепая оценка (blind submission), один сабмит на команду
- **Дата:** PAC1 запущен в 2025-2026; лидерборд продолжает обновляться
- **Значимость:** Самый строгий публичный бенчмарк для AI-агентов в 2026; выявил ключевые архитектурные паттерны (один сильный агент + рельсы + minimum tools)
- **Страница Insights:** https://bitgn.com/insights/ — официальные и team-submitted разборы архитектур
